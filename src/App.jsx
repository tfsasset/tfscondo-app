...
const PROJECT_LIST = [
  ...
  {
    zone: "พญาไท อารีย์ สะพานควาย จตุจักร ลาดพร้าว เกษตร",
    projects: [
      ...
      "IDEO MIX PHAHOLYOTHIN", "THE EDITOR SAPHAN KHWAI", "THE SIGNATURE BY URBANO","Grandio Ladprao Kaset Nawamin"
    ]
  }
];
...
const PublicView = ({ units, themeConfig, bannerUrl }) => {
  ...
  const [activeTab, setActiveTab] = useState('หาเช่า'); // เปลี่ยนค่าเริ่มต้นจาก 'หาซื้อ' เป็น 'หาเช่า'
...
const UnitFormModal = ({ isOpen, onClose, onSave, unitToEdit, themeConfig }) => {
  const [formData, setFormData] = useState({ 
    ...
    status: 'available', availableDate: '', price: '', 
